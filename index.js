    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(botNumber, { 
                ...
                \n Give a Star ⭐ to our bot:\n https://github.com/calyxdrey/Calyx-MD\n ✅Make sure to join below channel`,
                contextInfo: {
                    forwardingScore: 999,
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: CALYX DREY MOBILE HACKS`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: calyxdrey`))
